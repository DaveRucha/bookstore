      ...
      <div className="cart">
        <div className="cart-heading">
                <h1 className="cart-heading-h">
                    ...
                    <Typography variant="h3" component="h2" sx={{ color: "black", fontFamily: "unset", fontWeight: 'bold', paddingBottom: 2 }}> Cart Page </Typography>
                </h1> <hr />
            </div>
          ...
          <div className="cart-shopping">
            <h2>
            <Typography variant="h2" component="h2" sx={{  width :200 ,color: "black", fontFamily: "unset", fontWeight: 'bold', paddingBottom: 2 }}> My cart ({ itemsInCart} items) </Typography>
            </h2>
          
            <h4>
            <Typography variant="h2" component="h2" sx={{ color: "black",width :200 , fontFamily: "unset", fontWeight: 'bold', paddingBottom: 2 }}> Total Price : {totalPrice} </Typography>
            </h4>
          </div>
          ...
          {cartList.map((cartItem)=>{
            return(
              <div className="cart-product" key={cartItem.id}>
                ...
                <div className="cart-product-name">MRP
                  {/*  <CurrencyRupeeIcon fontSize="small" sx={{margin:"-5px"}}></CurrencyRupeeIcon> {cartItem.book.price} */}
                  </div>
        ...
        <div className="cart-place-order">
          <Button variant="contained" onClick={placeOrder} sx={{
            textTransform: "capitalize",backgroundColor: "#f14d54","&:hover": {
